...
Once uploaded to Scribd, this is what our knitr document looks like in a simple HTML-embedded reader:
...
The source code to generate the above embed dynamically (for example, in an R vignette like this one or in a Shiny app) is:
